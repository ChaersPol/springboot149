...
## 本项目获取地址：https://www.bishecode.com/product/146/
...
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图展示的就是管理员功能结构图，管理员在后台主要管理资产等。

![alt text](images/image-1.png)

# 五、效果图展示【部分效果图】

图5.1 校园资产列表页面【如图5.1显示的就是校园资产列表页面，此页面提供给管理员的功能有：查看校园资产、新增校园资产、修改校园资产、删除校园资产等。】
![alt text](images/image-2.png)

图5.2 资产维修信息管理页面【资产维修信息管理页面提供的功能操作有：新增资产维修，修改资产维修，删除资产维修操作。下图就是资产维修信息管理页面。】
![alt text](images/image-3.png)

图5.3 部门类型列表页面【部门类型管理页面显示所有部门类型，在此页面既可以让管理员添加新的部门信息类型，也能对已有的部门类型信息执行编辑更新，失效的部门类型信息也能让管理员快速删除。下图就是部门类型管理页面】
